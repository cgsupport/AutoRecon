...
echo""
nmap -T2 -p- -iL $home/workspaces/$COMPANYNAME/NMAP/External/extTargets.txt -oA $home/workspaces/$COMPANYNAME/NMAP/External/externaltcp -Pn &>/dev/null & nmap -T2 -sU -iL ~/workspaces/$COMPANYNAME/NMAP/External/extTargets.txt -oA ~/workspaces/$COMPANYNAME/NMAP/External/externaludp -Pn &>/dev/null &
echo ""
